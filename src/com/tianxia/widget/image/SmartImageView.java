...
public class SmartImageView extends ImageView {
    ...
    public void setImageUrl(String url, final Integer fallbackResource, final Integer loadingResource, boolean autoRotate) {
        setImage(new WebImage(url, autoRotate), fallbackResource, loadingResource);
    }
